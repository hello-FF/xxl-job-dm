#
# XXL-JOB v2.4.1-dm
# Copyright (c) 2015-present, huangchengfang.

# 创建数据库这一步建议手动操作，按如下方式

# CREATE TABLESPACE "XXL_JOB" DATAFILE '～/dm/data/DAMENG/XXL_JOB.DBF' size 128 autoextend ON NEXT 128 maxsize 10240;
# # 创建用户
# CREATE USER "XXL_JOB" IDENTIFIED BY "Xxl_JOB@2024" default TABLESPACE "XXL_JOB" DEFAULT INDEX TABLESPACE "XXL_JOB";
# # 授权
...
INSERT INTO "XXL_JOB"."XXL_JOB_GROUP"("ID","APP_NAME","TITLE","ADDRESS_TYPE","ADDRESS_LIST","UPDATE_TIME") VALUES(1,'xxl-job-executor-sample','示例执行器',0,null,TO_DATE('2018-11-03 22:21:31','YYYY-MM-DD HH24:MI:SS.FF'));
